...
The glossary has the approved display name, tooltip definition, and UX copy notes for each. Using the wrong term -- or the right term with wrong capitalisation -- damages trust.

If a term isn't in the curated section, check `References/product-glossary.md`'s "Extended terminology" section (broader coverage from the March 2026 master glossary) before assuming it isn't approved. For crypto and blockchain industry terms (not Deriv-specific), see `References/crypto-glossary.md`.
...
`References/product-glossary.md` -- Deriv-approved display names, tooltip definitions, and UX copy notes for all trade types, features, platforms, and markets, plus an EU availability quick reference and an extended terminology section pulled from the March 2026 master glossary. **Read this before writing copy that involves any product term.**
